...
sudo cp -r dist/eshakadakia.com/browser/* /var/www/eshakadakia.com/public_html/

# 5. Reset permissions
sudo chown -R www-data:www-data /var/www/eshakadakia.com/

echo "Deployment to eshakadakia.com successful at $(date)"